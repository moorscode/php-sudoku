...
Vagrant.configure(2) do |config|
    ...
    config.vm.synced_folder "..", "/home/docker/sudoku", id: "sudoku-dev" , type: "nfs"
    config.vm.synced_folder "~/.composer/", "/home/docker/.composer", id: "sudoku-composer" , type: "nfs"
    ...
    # Bring up containers
    config.vm.provision "shell", run: "always", inline: "cd /home/docker/sudoku/phpdocker && docker-compose up -d 1>&2"
